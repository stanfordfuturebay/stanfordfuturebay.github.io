...
names(reference_df) <-
  ...
  #join to patterns (cleaned up same day brand) -- this matches
...
most_related <-
  ...
  # for(row in april19_most_related_same_day_clean$most_related_same_day_brand_name_v[1:10]){
  #   i = match(most_related_same_day_brand_name_v, reference[, "location_name"])
