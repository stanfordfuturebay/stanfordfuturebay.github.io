...
**Longitudinal Plot (Tab 3)** - The primary longitudinal data available is on evictions. Census data can only be plotted as the change from 2010-2014 summary data to 2015-2019 summary data. The average line is shown in orange, and individual block groups can be added in blue.
...
**About the data** - Most data is from the American Communities Survey 2010-2014 or 2015-2019 5-year Detailed Tables (shown by default in plots, map, and table):
